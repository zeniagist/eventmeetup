...
//   if (token) {
//     removeQuery();
//     const url = `https://1up91ommwh.execute-api.ca-central-1.amazonaws.com/dev/api/token/${token}`;
//     const result = await axios.get(url);
...
//   const encodeCode = encodeURIComponent(code);
//   const { access_token } = await fetch(
//     `https://1up91ommwh.execute-api.ca-central-1.amazonaws.com/dev/api/get-events/${encodeCode}`
//   )
//     .then((res) => {
//       return res.json();
//     })
